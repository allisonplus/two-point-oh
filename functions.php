...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	set_post_thumbnail_size('highlight', 800, 500, true);
	...
	if ( function_exists( 'add_image_size' ) ) {
		add_image_size( 'blog', 970 ); //(full image)
	}
	...
	//function to get first uploaded image to set as feat. image if one doesn't already exist - home.php
	function main_image() {
	...
	//Adds Options page for to create ACF globally accessible
